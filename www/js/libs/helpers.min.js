(function(modules) {
    ...
    var R = {
        ...
        curry: __webpack_require__(102),
        keys: __webpack_require__(99)
    };
    function _createTableC(_ref2, cb) {
        var _this = this;
        var name = _ref2.name, fields = _ref2.fields;
        this.table = {
            name: name,
            fields: fields
        };
        ...
        this.DB.transaction(function(tx) {
            tx.executeSql("CREATE TABLE IF NOT EXISTS " + _this.table.name + " (" + _this.fields + ")", [], _ref3, _ref4);
        });
    }
    function _insertValueC(records, cb) {
        var _this2 = this;
        function _ref5() {
            if (cb) cb(null, "ok");
        }
        ...
        if (!records || records.length <= 0) cb(" No records ", null); else {
            this.DB.transaction(function(tx) {
                var values = "";
                for (var i = 0; i < records.length; i++) {
                    values += i == 0 ? "?" : ", ?";
                }
                tx.executeSql("INSERT INTO " + _this2.table.name + " (" + _this2.fields + ") VALUES (" + values + ")", records, _ref5, _ref6);
            });
        }
    }
    function _deleteValueC(values, cb) {
        var _this3 = this;
        ...
        function _ref9() {
            ...
            _this3.DB.transaction(function(tx) {
                return tx.executeSql("DELETE FROM " + _this3.table.name + " WHERE " + fds, vals, _ref7, _ref8);
            });
        }
        if ((typeof values === "undefined" ? "undefined" : (0, _typeof3.default)(values)) != "object" || fields.length <= 0) cb("Not fields to erase", null); else {
            var i;
            _ref9();
        }
    }
    function _getAllValues(cb) {
        var _this4 = this;
        var values = {};
        function _ref10(tx, results) {
            if (results.rows.length == 0) values = {}; else values = results.rows;
        }
        this.DB.transaction(function(tx) {
            tx.executeSql("SELECT * FROM " + _this4.table.name + " WHERE idRegistro = ? AND idPregunta = ?", [ _this4.app.idRegistro, _this4.app.idPregunta ], _ref10, null);
        });
    }
    ...
    function _getValues(_ref11, cb) {
        var _this5 = this;
        var field = _ref11.field, value = _ref11.value;
        var val = {};
        function _ref12(tx, results) {
            if (results.rows.length == 0) val = {}; else val = results.rows;
            if (cb) cb(val); else return val;
        }
        this.DB.transaction(function(tx) {
            tx.executeSql("SELECT * FROM " + _this5.table.name + " WHERE " + field + " = ? AND idRegistro = ? AND idPregunta = ?", [ value, _this5.app.idRegistro, _this5.app.idPregunta ], _ref12, null);
        });
    }
    function _updateValue(_ref13, cb) {
        var _this6 = this;
        var field = _ref13.field, value = _ref13.value, fieldWhere = _ref13.fieldWhere, valueWhere = _ref13.valueWhere;
        var res = "error";
        function _ref14(e) {
            return res = "ok";
        }
        ...
        this.DB.transaction(function(tx) {
            tx.executeSql("UPDATE " + _this6.table.name + " SET " + field + " = ? WHERE " + fieldWhere + " = ?", [ value, valueWhere ], _ref14, _ref15);
    ...
    function _updateValueById(_ref16) {
        var field = _ref16.field, value = _ref16.value, id = _ref16.id;
        this.updateValue({
            field: field,
            value: value,
            fieldWhere: "id",
    ...
    var SQLRecords = function() {
        function SQLRecords(_ref) {
            var name = _ref.name, description = _ref.description, size = _ref.size, app = _ref.app;
    ...
    function MakeId(a) {
        return a ? (0 | Math.random() * 16).toString(16) : ("" + 1e7 + -1e3 + -4e3 + -8e3 + -1e11).replace(/1|0/g, MakeId);
    }
    window.Helper = {
    ...
    var _curry2 = __webpack_require__(81);
    var _dispatchable = __webpack_require__(84);
    var _map = __webpack_require__(88);
    var _reduce = __webpack_require__(89);
    var _xmap = __webpack_require__(95);
    var curryN = __webpack_require__(97);
    ...
    var _curry1 = __webpack_require__(82);
    var _isPlaceholder = __webpack_require__(83);
    ...
    var _slice = __webpack_require__(87);
    ...
    var _arity = __webpack_require__(92);
    var _curry2 = __webpack_require__(81);
    ...
    var _curry1 = __webpack_require__(82);
    var _isArray = __webpack_require__(85);
    var _isString = __webpack_require__(94);
    ...
    var _curry2 = __webpack_require__(81);
    var _xfBase = __webpack_require__(96);
    module.exports = function() {
        function XMap(f, xf) {
            this.xf = xf;
            this.f = f;
    ...
    var _curry1 = __webpack_require__(82);
    var _curry2 = __webpack_require__(81);
    var _curryN = __webpack_require__(98);
    ...
    var _curry1 = __webpack_require__(82);
    var _has = __webpack_require__(100);
